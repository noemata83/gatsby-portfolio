...
const IndexPage = () => (
    <div className="tc-l mt4 mt5-m mt6-l ph3">
        ...
        <h2 className="fw1 f4 black-80 mt2 mb3">Hillsborough, NC</h2>
        <div className="dib fw1 center">
            <a className="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href="https://www.facebook.com/tucker.mckinney" title="">
                <svg data-icon="facebook" viewBox="0 0 32 32" style={{fill:"currentcolor"}}>
                <title>facebook icon</title>
                <path d="M8 12 L13 12 L13 8 C13 2 17 1 24 2 L24 7 C20 7 19 7 19 10 L19 12 L24 12 L23 18 L19 18 L19 30 L13 30 L13 18 L8 18 z"></path>
                </svg>
            </a>
            <a className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://github.com/noemata83" title="">
